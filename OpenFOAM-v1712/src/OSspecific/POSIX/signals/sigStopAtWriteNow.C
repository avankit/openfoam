...
thread_local int sigStopAtWriteNow::signal_
(
...
thread_local Foam::Time const* Foam::sigStopAtWriteNow::runTimePtr_ = nullptr;

thread_local struct sigaction Foam::sigStopAtWriteNow::oldAction_;
