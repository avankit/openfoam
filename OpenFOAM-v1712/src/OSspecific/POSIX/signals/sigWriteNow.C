...
thread_local int sigWriteNow::signal_
(
...
thread_local Foam::Time* Foam::sigWriteNow::runTimePtr_ = nullptr;

thread_local struct sigaction Foam::sigWriteNow::oldAction_;
