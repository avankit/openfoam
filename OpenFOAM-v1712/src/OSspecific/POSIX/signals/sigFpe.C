...
thread_local bool Foam::sigFpe::switchFpe_(Foam::debug::optimisationSwitch("trapFpe", 0));
thread_local bool Foam::sigFpe::switchNan_(Foam::debug::optimisationSwitch("setNaN", 0));

thread_local bool Foam::sigFpe::sigActive_ = false;
thread_local bool Foam::sigFpe::mallocNanActive_ = false;

thread_local struct sigaction Foam::sigFpe::oldAction_;
