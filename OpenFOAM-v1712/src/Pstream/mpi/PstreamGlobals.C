...
//! \cond fileScope
thread_local DynamicList<MPI_Request> PstreamGlobals::outstandingRequests_;
//! \endcond
...
//! \cond fileScope
thread_local int PstreamGlobals::nTags_ = 0;
//! \endcond

// Free'd message tags
//! \cond fileScope
thread_local DynamicList<int> PstreamGlobals::freedTags_;
//! \endcond


// Allocated communicators.
//! \cond fileScope
thread_local DynamicList<MPI_Comm> PstreamGlobals::MPICommunicators_;
thread_local DynamicList<MPI_Group> PstreamGlobals::MPIGroups_;
//! \endcond
