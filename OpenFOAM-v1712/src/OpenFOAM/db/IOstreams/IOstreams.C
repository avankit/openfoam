...
thread_local ISstream Sin(cin, "Sin");
thread_local OSstream Sout(cout, "Sout");
thread_local OSstream Serr(cerr, "Serr");
thread_local OFstream Snull("/dev/null");

thread_local prefixOSstream Pout(cout, "Pout");
thread_local prefixOSstream Perr(cerr, "Perr");
