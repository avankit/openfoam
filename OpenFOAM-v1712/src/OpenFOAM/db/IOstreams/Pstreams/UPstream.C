...
thread_local bool Foam::UPstream::parRun_(false);

thread_local bool Foam::UPstream::haveThreads_(false);

thread_local Foam::LIFOStack<Foam::label> Foam::UPstream::freeComms_;

thread_local Foam::DynamicList<int> Foam::UPstream::myProcNo_(10);

thread_local Foam::DynamicList<Foam::List<int>> Foam::UPstream::procIDs_(10);

thread_local Foam::DynamicList<Foam::label> Foam::UPstream::parentCommunicator_(10);

thread_local int Foam::UPstream::msgType_(1);


thread_local Foam::DynamicList<Foam::List<Foam::UPstream::commsStruct>>
...
thread_local bool Foam::UPstream::floatTransfer
(
...
thread_local int Foam::UPstream::nProcsSimpleSum
(
...
thread_local Foam::UPstream::commsTypes Foam::UPstream::defaultCommsType
(
...
thread_local Foam::label Foam::UPstream::worldComm(0);

thread_local Foam::label Foam::UPstream::warnComm(-1);

thread_local int Foam::UPstream::nPollProcInterfaces
(
...
thread_local int Foam::UPstream::maxCommsSize
(
...
thread_local const int Foam::UPstream::mpiBufferSize
(
