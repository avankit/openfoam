...
thread_local Foam::DLListBase::iterator Foam::DLListBase::endIter_
(
    const_cast<DLListBase&>(static_cast<const DLListBase&>(DLListBase()))
);

thread_local Foam::DLListBase::const_iterator Foam::DLListBase::endConstIter_
(
    static_cast<const DLListBase&>(DLListBase()),
    reinterpret_cast<const link*>(0)
);

thread_local Foam::DLListBase::const_reverse_iterator Foam::DLListBase::endConstRevIter_
(
    static_cast<const DLListBase&>(DLListBase()),
    reinterpret_cast<const link*>(0)
);
