...
thread_local dictionary* dimensionSystemsPtr_(nullptr);
thread_local HashTable<dimensionedScalar>* unitSetPtr_(nullptr);
thread_local dimensionSets* writeUnitSetPtr_(nullptr);
